...
image_bcicon = Image("bcicon", "BestClient/bc_icon.png")
image_bcdevicon = Image("bcdevicon", "BestClient/bc_dev_icon.png")
...
container.images.Add(image_bcicon)
container.images.Add(image_bcdevicon)
