...
// ProaledClient
#ifndef ProaledClient_VERSION
#define ProaledClient_VERSION PROALEDCLIENT_VERSION
#endif

// custom
#define CLIENT_NAME "ProaledClient"
#define CLIENT_RELEASE_VERSION PROALEDCLIENT_VERSION
