...
protected:
	...
	bool m_ShowStart;
	bool m_MenuActive;
	float m_PcIngameMenuOpenPhase = 0.0f;
	bool m_PcIngameMenuClosing = false;
	...
	void ToggleProaledClientServerFilter();
	...
	void RenderServerbrowserProaledClient(CUIRect View);
...
public:
	...
	enum
	{
		...
		SMALL_TAB_BROWSER_PROALEDCLIENT,
...
private:
	...
	void RenderSettingsProaledClient(CUIRect MainView);
	void RenderSettingsProaledClientInfo(CUIRect MainView);
	void RenderSettingsProaledClientFun(CUIRect MainView);
