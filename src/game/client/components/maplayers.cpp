...
void CMapLayers::OnRender()
{
	...
	m_Params.m_FpsFogMode = g_Config.m_PcOptimizerFpsFogMode;
	m_Params.m_FpsFogRadiusTiles = g_Config.m_PcOptimizerFpsFogRadiusTiles;
	m_Params.m_FpsFogZoomPercent = g_Config.m_PcOptimizerFpsFogZoomPercent;
	m_Params.m_FpsFogCullMapTiles = OptimizerFpsFogEnabled && g_Config.m_PcOptimizerFpsFogCullMapTiles != 0;
