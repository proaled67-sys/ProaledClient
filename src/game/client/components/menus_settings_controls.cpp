...
void CMenusSettingsControls::OnInterfacesInit(CGameClient *pClient)
{
	...
	m_vBindOptions = {
		...
		{EBindOptionGroup::BEST_CLIENT, Localizable("Deepfly toggle"), "PC_deepfly_toggle"},
		{EBindOptionGroup::BEST_CLIENT, Localizable("45 deg bind"), "+PC_45_degrees"},
		{EBindOptionGroup::BEST_CLIENT, Localizable("Small sens bind"), "PC_small_sens"},
...
void CMenusSettingsControls::Render(CUIRect MainView)
{
	...
	RenderSettingsBindsBlock(EBindOptionGroup::BEST_CLIENT, &RightColumn, Localize("ProaledClient"));
	RenderSettingsBindsBlock(EBindOptionGroup::BEST_CLIENT_VOICE, &RightColumn, Localize("ProaledClient Voice"));
	RenderSettingsBindsBlock(EBindOptionGroup::BEST_CLIENT_PRACTICE, &RightColumn, Localize("ProaledClient Practice"));
