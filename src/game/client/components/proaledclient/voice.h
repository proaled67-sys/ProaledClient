#ifndef GAME_CLIENT_COMPONENTS_PROALEDCLIENT_VOICE_H
#define GAME_CLIENT_COMPONENTS_PROALEDCLIENT_VOICE_H
...
{
	int m_PcVoiceFilterEnable = 0;
	int m_PcVoiceNoiseSuppressEnable = 0;
	int m_PcVoiceNoiseSuppressStrength = 0;
	int m_PcVoiceCompThreshold = 0;
	int m_PcVoiceCompRatio = 0;
	int m_PcVoiceCompAttackMs = 0;
	int m_PcVoiceCompReleaseMs = 0;
	int m_PcVoiceCompMakeup = 0;
	int m_PcVoiceLimiter = 0;
	int m_PcVoiceStereo = 0;
	int m_PcVoiceStereoWidth = 0;
	int m_PcVoiceRadius = 0;
	int m_PcVoiceVolume = 0;
	int m_PcVoiceMicVolume = 0;
	int m_PcVoiceMicMute = 0;
	int m_PcVoiceTestMode = 0;
	int m_PcVoiceVadEnable = 0;
	int m_PcVoiceVadThreshold = 0;
	int m_PcVoiceVadReleaseDelayMs = 0;
	int m_PcVoiceIgnoreDistance = 0;
	int m_PcVoiceGroupGlobal = 0;
	int m_PcVoiceVisibilityMode = 0;
	int m_PcVoiceListMode = 0;
	int m_PcVoiceDebug = 0;
	int m_PcVoiceGroupMode = 0;
	int m_PcVoiceHearOnSpecPos = 0;
	int m_PcVoiceHearPeoplesInSpectate = 0;
	int m_PcVoiceHearVad = 0;
	int m_ClShowOthers = 0;
	uint32_t m_PcVoiceTokenHash = 0;
	char m_aPcVoiceWhitelist[512] = {};
	char m_aPcVoiceBlacklist[512] = {};
	char m_aPcVoiceMute[512] = {};
	char m_aPcVoiceVadAllow[512] = {};
	char m_aPcVoiceNameVolumes[512] = {};
};

class CProaledClientVoice
{
	struct SVoicePeer
	{
...
#endif // GAME_CLIENT_COMPONENTS_PROALEDCLIENT_VOICE_H
