...
#define PC_VISUALIZER_HAS_WASAPI 1
#include <winrt/base.h>
#if !defined(NOBITMAP)
#define PC_VISUALIZER_DEFINED_NOBITMAP
#define NOBITMAP
#endif
...
#undef IStorage
#if defined(PC_VISUALIZER_DEFINED_NOBITMAP)
#undef PC_VISUALIZER_DEFINED_NOBITMAP
#undef NOBITMAP
#endif
#else
#define PC_VISUALIZER_HAS_WASAPI 0
#endif
