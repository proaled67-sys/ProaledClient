#ifndef GAME_CLIENT_COMPONENTS_PROALEDCLIENT_BINDWHEEL_H
#define GAME_CLIENT_COMPONENTS_PROALEDCLIENT_BINDWHEEL_H
...
enum
{
	BINDWHEEL_MAX_NAME_PROALEDCLIENT = 64,
	BINDWHEEL_MAX_CMD_PROALEDCLIENT = 1024,
	BINDWHEEL_MAX_BINDS_PROALEDCLIENT = 64
};

class CBindWheelSpec : public CComponent
{
	float m_AnimationTime = 0.0f;
	float m_aAnimationTimeItems[BINDWHEEL_MAX_BINDS_PROALEDCLIENT] = {0};
...
public:
	...
	{
	public:
		char m_aName[BINDWHEEL_MAX_NAME_PROALEDCLIENT] = "EMPTY";
		char m_aCommand[BINDWHEEL_MAX_CMD_PROALEDCLIENT] = "";
