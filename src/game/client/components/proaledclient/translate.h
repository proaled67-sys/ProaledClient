...
#ifndef GAME_CLIENT_COMPONENTS_PROALEDCLIENT_TRANSLATE_H
#define GAME_CLIENT_COMPONENTS_PROALEDCLIENT_TRANSLATE_H
...
#endif // GAME_CLIENT_COMPONENTS_PROALEDCLIENT_TRANSLATE_H
