...
public:
	...
	void UpdateServerProaledClients(CServerInfo *pInfo) const;
	...
	void SetProaledClientPlayers(const std::vector<CProaledClientPlayerEntry> &vPlayers) override;
...
private:
	...
	std::unordered_map<std::string, std::unordered_map<std::string, bool>> m_ProaledClientPlayersByServer;
	...
	bool SortCompareNumProaledClientPlayers(int Index1, int Index2) const;
