...
static int GetEffectiveCustomAspect(bool ApplyCustomAspect)
{
	...
	if(AspectMode <= 0)
		return 0;
	return g_Config.m_PcCustomAspectRatio >= 100 ? g_Config.m_PcCustomAspectRatio : 0;
}
...
void CGraphics_Threaded::SetForcedAspect(bool Force, bool ApplyCustomAspect)
{
	...
	{
		const int AspectMode = g_Config.m_PcCustomAspectRatioMode >= 0 ? g_Config.m_PcCustomAspectRatioMode : (g_Config.m_PcCustomAspectRatio > 0 ? 1 : 0);
		if(AspectMode == 2 && g_Config.m_PcCustomAspectRatioNum > 0 && g_Config.m_PcCustomAspectRatioDen > 0)
			CustomAspectF = (float)g_Config.m_PcCustomAspectRatioNum / (float)g_Config.m_PcCustomAspectRatioDen;
		else
