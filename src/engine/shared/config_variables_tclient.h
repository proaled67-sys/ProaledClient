...
MACRO_CONFIG_STR(PcTranslateIncomingSource, pc_translate_incoming_source, 16, "auto", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Source language for incoming chat translation (use auto to detect)")
MACRO_CONFIG_STR(PcTranslateIncomingIgnoreLanguages, pc_translate_incoming_ignore_languages, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Semicolon-separated source languages that should not be auto-translated, e.g. ru; en; zh")
...
MACRO_CONFIG_STR(PcTranslateOutgoingSource, pc_translate_outgoing_source, 16, "auto", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Source language for your outgoing chat translation (use auto to detect)")
MACRO_CONFIG_STR(PcTranslateOutgoingTarget, pc_translate_outgoing_target, 16, "en", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Target language for your outgoing chat translation")
...
MACRO_CONFIG_INT(TcUiShowProaledClient, tc_ui_show_proaledclient, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show ProaledClient domain in Configs tab")
