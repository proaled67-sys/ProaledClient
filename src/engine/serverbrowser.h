...
public:
	...
	public:
		...
		bool m_ProaledClient;
		bool m_ProaledClientDeveloper;
	};
	...
	int m_NumProaledClientPlayers;
	bool m_HasProaledClientPlayers;
	int m_NumProaledClientDeveloperPlayers;
	bool m_HasProaledClientDeveloperPlayers;
...
public:
		/* Constants: Server Browser Sorting
			...
			SORT_NUMPROALEDCLIENT - Sort after how many ProaledClient players there are on the server.
		*/
		enum
		{
			SORT_NAME = 0,
	...
	struct CProaledClientPlayerEntry
	{
	...
	virtual void SetProaledClientPlayers(const std::vector<CProaledClientPlayerEntry> &vPlayers) = 0;
};
